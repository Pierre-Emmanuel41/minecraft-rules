...
public enum EGameRuleMessageCode implements IMinecraftMessageCode {
	...
	// Code for command appleDropRate
	APPLE_DROP_RATE__EXPLANATION, APPLE_DROP_RATE__DROP_RATE_ON_TAB_COMPLETE, APPLE_DROP_RATE__VALUE_OUT_OF_BOUND, APPLE_DROP_RATE__DROP_RATE_DEFAULT,

	// Code for command naturalRegeneration
	NATURAL_REGENERATION__EXPLANATION;
