...
public enum EGameRuleMessageCode implements IMinecraftMessageCode {
	...
	MOBS_NOT_ALLOWED_TO_SPAWN_GAME_RULE__ONE_MOB_NOT_ALLOWED, MOBS_NOT_ALLOWED_TO_SPAWN_GAME_RULE__SEVERAL_MOBS_NOT_ALLOWED, MOBS_NOT_ALLOWED_TO_SPAWN_GAME_RULE__RESET;
